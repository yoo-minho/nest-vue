...
import { Quasar, Notify, Dialog, BottomSheet, LocalStorage, Dark, AddressbarColor, Loading } from 'quasar';
...
myApp.use(Quasar, {
  plugins: { Notify, Dialog, BottomSheet, LocalStorage, AddressbarColor, Loading },
});
